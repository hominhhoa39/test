(function() {
    ...
    document.onmousemove = function(e) {
        setTimeout(function() {
            var mouseObj = document.getElementById("mouseImg").style;
            mouseObj.left = e.pageX + hx + "px";
            mouseObj.top = e.pageY + hy + "px";
            var divPosition = document.getElementById("position");
            divPosition.innerHTML = "カーソルの位置　X: " + e.pageX + "　Y: " + e.pageY + "<br>" +
			                        "画像の位置　  X: " + (e.pageX + hx) + "　Y: " + (e.pageY + hy);
        }, 100);
    }
}());